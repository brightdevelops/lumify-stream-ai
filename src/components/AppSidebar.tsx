...
import { LayoutDashboard, Video, Wallet, Receipt, Settings, LogOut, Shield, Wrench, GraduationCap, Plus, Mic, KeyRound } from "lucide-react";
...
const items = [
  ...
  { to: "/api-keys", label: "API keys", icon: KeyRound, tour: "api-keys" },
] as const;
