        ...
        <div className="mt-10 space-y-10 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              recordings are retained until you delete them from your account. You can delete your
              account at any time from Settings; residual backup copies are purged on our normal
              backup rotation.
            </p>
          </section>
